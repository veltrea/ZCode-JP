...
export const desktopMenuMessages: Record<Locale, DesktopMenuLocaleMessages> = {
  ...
  "ja-JP": {
    ...
    "titleBar.menu.view.toggleFullScreen": "フルスクリーンを切り替え",
    "titleBar.menu.view.actualSize": "実際のサイズ",
    "titleBar.menu.view.zoomIn": "拡大",
    "titleBar.menu.view.zoomOut": "縮小",
    "titleBar.menu.window.minimize": "しまう",
    "titleBar.menu.window.zoom": "拡大／縮小",
    "titleBar.menu.window.bringAllToFront": "すべてを前面に表示",
    ...
    "titleBar.menu.help.about": "ZCode について",
    "titleBar.menu.help.whatsNew": "更新履歴",
    ...
    "titleBar.menu.help.toggleZCodeStdioTap": "Agent の stdio 通信を記録",
    "titleBar.menu.help.zcodeEndpoint": "ZCode Endpoint",
    "titleBar.menu.help.zcodeEndpoint.production": "Production（既定）",
    "titleBar.menu.help.zcodeEndpoint.test": "Test",
    "titleBar.menu.help.zcodeEndpoint.custom": "カスタム...",
    "titleBar.menu.help.zcodeEndpoint.reset": "既定値に戻す",
    "titleBar.menu.help.feedback": "問題を報告",
    "titleBar.menu.help.exportLogs": "ログを書き出す",
    "titleBar.menu.help.clearAllData": "すべてのデータを消去",
    "desktopMenu.help.checkingForUpdates": "更新を確認しています...",
    "desktopMenu.help.updateAvailableVersion": "新しいバージョン {version} があります",
    "desktopMenu.help.downloadingUpdateVersion": "更新 {version} をダウンロードしています...",
    "desktopMenu.help.downloadingUpdateProgress": "更新をダウンロードしています... {progress}",
    "desktopMenu.help.restartToUpdate": "再起動して更新する（{version}）",
    "dock.menu.showCurrentWindow": "現在のウインドウを表示",
    "tray.tooltip": "ZCode",
    "tray.menu.openZCode": "ZCode を開く",
    "tray.menu.quit": "終了",
  },
};
