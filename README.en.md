**Read this in other languages:** [日本語](README.md) | [简体中文](README.zh-CN.md)
...
The changes intended for upstream are kept on the [`ja-localize`](https://github.com/veltrea/ZCode-JP/tree/ja-localize) branch, which changes upstream files as little as possible.
...
- Adds Japanese documents: [README.md](README.md) (the Japanese top page), [NOTICE.ja.md](NOTICE.ja.md), and [apps/zcode-cli/README.ja.md](apps/zcode-cli/README.ja.md).
